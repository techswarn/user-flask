...
app.config['MONGO_URI'] = "mongodb+srv://flaskuser:4DbG652y8pY9Eq37@app-db01-fe45a622.mongo.ondigitalocean.com/admin?tls=true&authSource=admin&replicaSet=app-db01"
